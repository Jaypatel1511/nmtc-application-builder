...
class PDFApplicationBuilder:
    ...
    def _eligibility_source_line(self) -> str:
        ...
        base = (
            "ELIGIBILITY: CDFI Fund NMTC Eligibility Table, 2016–2020 ACS "
            "5-Year Estimates."
        )
    ...
    def _methodology(self, styles) -> list:
        ...
        text = (
            ...
            "(Poverty&gt;30%; MFI&lt;=60%; Unemployment&gt;=1.5). Deep distress = "
            "LIC AND (Poverty&gt;40%; MFI&lt;=40%; Unemployment&gt;=2.5). The "
            "semicolons are ORs; both tiers additionally require the tract to be "
            "a Low-Income Community.<br/><br/>"
